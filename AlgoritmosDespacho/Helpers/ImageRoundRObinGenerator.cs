...
{
    public class ImageRoundRobinGenerator
    {
        ...
        public void GenerateImage(PlotModel plotModel, List<RoundRobinProcessModel> procesos, double promedioTiempoEspera, double promedioTiempoSistema, string imagePath)
        {
        ...
        private void DrawTableAndSaveImage(PlotModel plotModel, List<RoundRobinProcessModel> procesos, double promedioTiempoEspera, double promedioTiempoSistema, string filePath)
        {
        ...
        private void DrawTableOnCanvas(List<RoundRobinProcessModel> procesos, double promedioTiempoEspera, double promedioTiempoSistema, SKCanvas canvas)
        {
        ...
        private void DrawTableRows(SKCanvas canvas, List<RoundRobinProcessModel> procesos, int startX, int startY, int rowHeight, SKPaint paint)
        {
            for (int i = 0; i < procesos.Count; i++)
            {
                var proceso = procesos[i];
                canvas.DrawText(proceso.Proceso, startX, startY + i * rowHeight, paint);
                canvas.DrawText(proceso.Comienzo.First().ToString(), startX + 100, startY + i * rowHeight, paint);
                canvas.DrawText(proceso.Finalizacion.Last().ToString(), startX + 250, startY + i * rowHeight, paint);
            }
        }
        ...
        internal void CreateImage(PlotModel plotModel, List<RoundRobinProcessModel> procesos, double promedioTiempoEspera, double promedioTiempoSistema, string v)
        {
